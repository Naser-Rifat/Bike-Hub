            ...
            <Box sx={{ flexGrow: 1 }}>
                <Grid container spacing={2}>
                    <Grid item xs={12} sm={12} md={6}>
                        <img style={{ width: "100%" }} src="https://yokoo.themerex.net/wp-content/uploads/2019/09/image-copyright-3-1536x864.png" alt="No_img" />
                    </Grid>
                    <Grid item xs={12} sm={12} md={5} style={{ textAlign: 'left', marginLeft: "50px" }}>
                        ...
                        <Button variant="contained" style={{ backgroundColor: "rgb(102, 220, 230)" }} >Learn more</Button>
                    </Grid>
